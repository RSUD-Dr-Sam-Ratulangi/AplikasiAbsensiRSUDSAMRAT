      ...
      .then(({newPath}) => {
        ...
        try {
          ...
          Alert.alert(
            ...
            'Pastikan anda memiliki jadwal. Jika ada kendala, mohon hubungi admin.',
        ...
        axios
          ...
          .catch(err => {
            ...
            Alert.alert(
              ...
              'Pastikan anda Check Out sesuai jadwal. Jika ada kendala, mohon hubungi admin.',
              [{text: 'OK', onPress: () => console.log('OK Pressed')}],
            );
            navigation.replace('Tabs');
          });
  ...
  const setCheckInOrOut = async attendanceDate => {
    ...
    try {
      const response = await axios.get(
        `http://rsudsamrat.site:9999/api/v1/dev/attendances/byDateAndEmployee?attendanceDate=${newDate}&employeeId=${employeeIdd}`,
      );
      if (
        response.data ===
  ...
  const test = async () => {
    ...
    try {
      const res = await axios.get(
        `http://rsudsamrat.site:9999/api/v1/dev/attendances/byDateAndEmployee?attendanceDate=${attendanceDate}&employeeId=${employeeIdd}`,
      );
      console.log(res.data[0].clockIn);
    } catch (err) {
      console.log(err);
    }
  };
